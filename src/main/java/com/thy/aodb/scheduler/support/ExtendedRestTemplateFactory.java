...
public class ExtendedRestTemplateFactory implements FactoryBean<RestTemplate>, InitializingBean {
	...
	public void afterPropertiesSet() {
		try {
			LOGGER.debug("Initializing Extended Rest Template... : {} , {} , {}", getSchema(), getRootURL(), getHttpPort());
			...
			LOGGER.debug("Extended Rest Template Initialized Successfully...");
		} catch (Exception e) {
			LOGGER.error("Extended Rest Template Initialization FAILED...", e);
		}
	}
